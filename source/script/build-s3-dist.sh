...
echo "--------------------------------------------"
echo "[Packing] Online Lambda function"
echo "--------------------------------------------"
# Copy shared folder to online lambda directory for Docker build
rm -rf "$lambda_source_dir"/online/shared
cp -r "$lambda_source_dir"/shared "$lambda_source_dir"/online/shared
